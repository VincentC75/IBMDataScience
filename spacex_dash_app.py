...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df,
         values='Count', 
         names='class', 
         title='Launch Outcomes on site ' + entered_site)
        return fig
...
def get_scatterplot(entered_site, slider):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df,
          ...
          title='Outcome given Payload on All Sites')
        return fig
    else:
        # return the outcomes piechart for a selected site
        ...
        fig = px.scatter(filtered_df,
          ...
          y='class',
          color='Booster Version Category',
          title='Outcome given Payload on Site ' + entered_site)
        return fig
